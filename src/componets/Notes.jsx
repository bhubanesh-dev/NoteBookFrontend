  ...
  return (
    <>
      <div className="setCointainer">
        <h2 className="text-center text-light pt-5">Your Notes</h2>
        <div
          className="cointainer setScroll overflow-y-scroll overflow-x-hidden"
          style={{ height: "70vh", width: "100%" }}
        >
          {/* modal for addnote */}
          <button
            type="button"
            className="btn btn-transparent border-light   addbutton"
